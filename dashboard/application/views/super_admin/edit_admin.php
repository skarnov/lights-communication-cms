                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form action="<?php echo base_url(); ?>super_admin/update_admin" method="POST" name="admin" class="form-horizontal form-label-left" novalidate>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Panel <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Select Admin Type <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
...
<script>
    document.forms['admin'].elements['level'].value = '<?php echo $admin_info->admin_level; ?>';
    document.forms['admin'].elements['type'].value = '<?php echo $admin_info->admin_type; ?>';
